...
namespace CiOHomePage.Server.Migrations
{
 ...
 IsBandWide = table.Column<bool>(type: "INTEGER", nullable: false),
 ...
 constraints: table =>
 {
 table.PrimaryKey("PK_MerchSales", x => x.Id);
 });
 ...
 RespondedUtc = table.Column<DateTime>(type: "TEXT", nullable: false)
 },
 constraints: table =>
 {
